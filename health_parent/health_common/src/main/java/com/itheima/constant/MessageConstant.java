...
public class MessageConstant {
    ...
    public static final String VALIDATECODE_SUCCESS = "验证码验证成功";
    ...
    public static final String CHANGGE_PASSWORD_SUCCESS = "更改密码成功";
    ...
    public static final String CHANGGE_PASSWORD_FAIL = "密码更改失败";
